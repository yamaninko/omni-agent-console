...
internal static class AgentPromptBuilder
{
    ...
    private static string GetRoleInstruction(AgentType agentType)
    {
        return agentType switch
        {
            ...
            AgentType.Reviewer => "Review previous outputs for correctness, security, consistency, missing steps, and architectural fit. Always check for Dockerfile + docker-compose.yml + /health. Return prioritized findings and concrete fixes.",
